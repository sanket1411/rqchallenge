package com.example.rqchallenge.employees.restexecutor;
...
public class RestTemplateExecutor {
  ...
  public <T> Optional<T> execute(
      String resourcePath, HttpMethod method, Object request, Class<T> responseType) {
    ...
    switch (method) {
      ...
      case PUT:
        ...
        return Optional.ofNullable(
            restTemplate.exchange(url, HttpMethod.PUT, httpEntityPut, responseType).getBody());
      case DELETE:

...
public interface IEmployeeController {
  ...
  @Operation(
      summary = "Get all employee records with name matching with searchString",
      description = "Returns all matched employee records")
  @ApiResponses(value = {@ApiResponse(code = 200, message = "Successfully retrieved")})
  @GetMapping("/search/{searchString}")
  ResponseEntity<List<Employee>> getEmployeesByNameSearch(
      @PathVariable("searchString") @NotBlank @Size(max = 512) String searchString);
  ...
  ResponseEntity<Employee> getEmployeeById(
      @PathVariable("id") @NotBlank @Size(max = 256) String id);

  @Operation(
      summary = "Get highest salary from all employees",
      description = "Returns highest salary from all employees")
  @ApiResponses(value = {@ApiResponse(code = 200, message = "Successfully retrieved")})
  @GetMapping("/highestSalary")
  ResponseEntity<Integer> getHighestSalaryOfEmployees();

  @Operation(
      summary = "Get top 10 highest employee names",
      description = "Returns names of top ten earning employees")
  @ApiResponses(value = {@ApiResponse(code = 200, message = "Successfully retrieved")})

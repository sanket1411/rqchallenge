...
public class ExceptionLogger {
    ...
    @AfterThrowing(pointcut = "execution(* com.example.rqchallenge.employees.service.EmployeeService.*(..)))||execution(* com.example.rqchallenge.employees.service.EmployeeService.*(..)))", throwing = "ex")

...
public class EmployeeServiceTests {
    ...
    static class EmployeeServiceTestContextConfiguration {
        ...
        @MockBean
        public static RestTemplateExecutor restTemplateExecutor;
    ...
    public void testGetEmployees() throws Exception {
        ...
        Mockito.when(EmployeeServiceTestContextConfiguration.restTemplateExecutor.execute("employees", HttpMethod.GET, null, String.class)).thenReturn(Optional.ofNullable(getMockMultiResponse()));
        mockMvc.perform(get("/")).
    ...
    public void testGetEmployeesEmpty() throws Exception {
        ...
        Mockito.when(EmployeeServiceTestContextConfiguration.restTemplateExecutor.execute("employees", HttpMethod.GET, null, String.class)).thenReturn(Optional.ofNullable(getEmptyMockResponse()));
        mockMvc.perform(get("/")).
                andExpect(status().isOk()).
    ...
    public void testGetEmployeesError() throws Exception {
        ...
        Mockito.when(EmployeeServiceTestContextConfiguration.restTemplateExecutor.execute("employees", HttpMethod.GET, null, String.class)).thenReturn(Optional.ofNullable(getMockErrorResponse()));
        mockMvc.perform(get("/")).
    ...
    public void testGetEmployeesByNameSearch() throws Exception {
        ...
        Mockito.when(EmployeeServiceTestContextConfiguration.restTemplateExecutor.execute("employees", HttpMethod.GET, null, String.class)).thenReturn(Optional.ofNullable(getMockMultiResponse()));
        mockMvc.perform(get("/search/tiger"))
                .andExpect(status().isOk())
    ...
    public void testCreateEmployee() throws Exception {
        ...
        String response = "{\n" +
                ...
                "\"profile_image\": \"\"\n" +
                "}";
        String res = "{\"status\":\"success\",\"data\":" + response + ",\"message\":\"Successfully! All records has been fetched.\"}\n";

        Mockito.when(EmployeeServiceTestContextConfiguration.restTemplateExecutor.execute(any(), any(), any(), any())).thenReturn(Optional.ofNullable(res));
    ...
    public void testCreateEmployeeError() throws Exception {
        ...
        Mockito.when(EmployeeServiceTestContextConfiguration.restTemplateExecutor.execute(any(), any(), any(), any())).thenReturn(Optional.ofNullable(null));
        mockMvc.perform(MockMvcRequestBuilders.post("/")
                        .content(createJson)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().is5xxServerError())
